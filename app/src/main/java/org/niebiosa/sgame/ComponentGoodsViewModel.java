...
public class ComponentGoodsViewModel extends ViewModel {
    ...
    public MutableLiveData<String> getMithril() {
        return mithril;
    }

    public MutableLiveData<String> getWood() {
        return wood;
    }

    public MutableLiveData<String> getBread() {
        return bread;
    }

    public MutableLiveData<String> getFish() {
        return fish;
    }
}
